...
class Request_BundlesCoreLinuxUbuntuInstall_Docker(BaseModel):
...
class Reply_BundlesCoreLinuxUbuntuInstall_DockerItem(BaseModel):
...
class Reply_BundlesCoreLinuxUbuntuInstall_Docker(BaseModel):

    rc: int = Field(0, description="RETURN code (0 = OK)")
    result: list[Reply_BundlesCoreLinuxUbuntuInstall_DockerItem]
