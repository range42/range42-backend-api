...
Request_BundlesCoreProxmoxConfigureDefaultVms_CreateAdminVmsItem = (
    BundleCreateAdminVmsItemRequest
)
Request_BundlesCoreProxmoxConfigureDefaultVms_CreateAdminVms = (
    BundleCreateAdminVmsRequest
)
Reply_BundlesCoreProxmoxConfigureDefaultVms_CreateAdminVmsItem = (
    BundleCreateAdminVmsItemReply
)
...
Request_BundlesCoreProxmoxConfigureDefaultVms_CreateStudentVmsItem = (
    BundleCreateStudentVmsItemRequest
)
Request_BundlesCoreProxmoxConfigureDefaultVms_CreateStudentVms = (
    BundleCreateStudentVmsRequest
)
Reply_BundlesCoreProxmoxConfigureDefaultVms_CreateStudentVmsItem = (
    BundleCreateStudentVmsItemReply
)
...
Request_BundlesCoreProxmoxConfigureDefaultVms_CreateVulnVmsItem = (
    BundleCreateVulnVmsItemRequest
)
Request_BundlesCoreProxmoxConfigureDefaultVms_CreateVulnVms = BundleCreateVulnVmsRequest
Reply_BundlesCoreProxmoxConfigureDefaultVms_CreateVulnVmsItem = (
    BundleCreateVulnVmsItemReply
)
...
Request_BundlesCoreProxmoxConfigureDefaultVms_RevertSnapshotAdminVulnStudentVms = (
    BundleRevertSnapshotDefaultRequest
)
