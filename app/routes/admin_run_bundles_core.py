...
from app.routes.v0.admin.bundles.proxmox.configure.default.vms.start_stop_pause_resume_vuln    import router as bundles_proxmox_configure_default_vms_start_stop_resume_pause_default_router      #
...
router.include_router(bundles_proxmox_configure_default_vms_start_stop_resume_pause_default_router, prefix="/v0/admin/run/bundles")     # ISSUE 30