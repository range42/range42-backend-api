...
# temp
router.include_router(debug_test_func, prefix="/v0/debug")
...
#
# /v0/proxmox/firewall/  - issue #13, #12
#
router.include_router(proxmox_firewall_list_iptables_alias_router,             prefix="/v0/proxmox/firewall")
router.include_router(proxmox_firewall_add_iptables_alias_router,              prefix="/v0/proxmox/firewall")
router.include_router(proxmox_firewall_delete_iptables_alias_router,           prefix="/v0/proxmox/firewall")

router.include_router(proxmox_firewall_list_iptables_rules_router,             prefix="/v0/proxmox/firewall")
router.include_router(proxmox_firewall_apply_iptables_rules_router,            prefix="/v0/proxmox/firewall")
router.include_router(proxmox_firewall_delete_iptables_rule_router,            prefix="/v0/proxmox/firewall")

router.include_router(proxmox_firewall_enable_firewall_vm_router,              prefix="/v0/proxmox/firewall")
router.include_router(proxmox_firewall_disable_firewall_vm_router,             prefix="/v0/proxmox/firewall")

router.include_router(proxmox_firewall_enable_firewall_node_router,            prefix="/v0/proxmox/firewall")
router.include_router(proxmox_firewall_disable_firewall_node_router,           prefix="/v0/proxmox/firewall")
