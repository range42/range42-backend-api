...
from app.schemas.network import (
    Reply_ProxmoxNetwork_WithNodeName_AddNetworkInterface,
    Reply_ProxmoxNetwork_WithNodeName_DeleteInterface,
    ...
    Request_ProxmoxNetwork_WithNodeName_DeleteInterface,
    Request_ProxmoxNetwork_WithNodeName_ListInterface,
...
@router.post(
    path="/vm/delete",
    summary="Delete VM network interface",
    description="Remove a network interface from a Proxmox VM.",
    tags=["proxmox - network - vm"],
    response_model=Reply_ProxmoxNetwork_WithVmId_DeleteNetworkInterface,
    response_description="Information about the deleted network interface.",
)
def proxmox_network_vm_delete_interface(
    req: Request_ProxmoxNetwork_WithVmId_DeleteNetwork,
):
...
def proxmox_network_node_add_interface(
    req: Request_ProxmoxNetwork_WithNodeName_AddNetworkInterface,
):
...
@router.post(
    path="/node/delete",
    summary="Delete node network interface",
    description="Remove a network interface from a Proxmox node.",
    tags=["proxmox - network - node"],
    response_model=Reply_ProxmoxNetwork_WithNodeName_DeleteInterface,
    response_description="Information about the deleted network interface.",
)
def proxmox_network_node_delete_interface(
...
@router.post(
    ...
    description="Retrieve all network interfaces configured on a Proxmox node.",
    tags=["proxmox - network - node"],
    response_model=Reply_ProxmoxNetwork_WithNodeName_ListInterface,
    response_description="List of node network interfaces.",
)
def proxmox_network_node_list_interface(
    req: Request_ProxmoxNetwork_WithNodeName_ListInterface,
):
