...
from app.schemas.proxmox.storage.storage_name.list_template import Request_ProxmoxStorage_ListTemplate
from app.schemas.proxmox.storage.storage_name.list_template import Reply_ProxmoxStorageWithStorageName_ListTemplate
...
@router.post(
    ...
    response_model=Reply_ProxmoxStorageWithStorageName_ListTemplate,
...
def reply_processing(events: list[dict] | list[Any],
                     ...
                     log_plain: str,
                     rc,
                     req: Request_ProxmoxStorage_ListTemplate) -> dict[str, list | Any]:
...
def request_checks(req: Request_ProxmoxStorage_ListTemplate) -> dict[Any, Any]:
    """ request checks """

    extravars = {}
    extravars["proxmox_vm_action"] = "storage_list_template"
