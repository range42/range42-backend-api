...
from app.schemas.proxmox.storage.storage_name.list_iso import Request_ProxmoxStorage_ListIso
...
def reply_processing(events: list[dict] | list[Any],
                     ...
                     log_plain: str,
                     rc,
                     req: Request_ProxmoxStorage_ListIso) -> dict[str, list | Any]:
...
def request_checks(req: Request_ProxmoxStorage_ListIso) -> dict[Any, Any]:
    """ request checks """

    extravars = {}
    extravars["proxmox_vm_action"] = "storage_list_iso"
