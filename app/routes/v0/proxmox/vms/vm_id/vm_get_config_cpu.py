...
from app.schemas.proxmox.vm_id.vm_get_config_cpu import Request_ProxmoxVmsVMID_VmGetConfigCpu
from app.schemas.proxmox.vm_id.vm_get_config_cpu import Reply_ProxmoxVmsVMID_VmGetConfigCpu
...
def proxmox_vms_vm_id_pause(req: Request_ProxmoxVmsVMID_VmGetConfigCpu):
...
def reply_processing(events: list[dict] | list[Any],
                     ...
                     log_plain: str,
                     rc,
                     req: Request_ProxmoxVmsVMID_VmGetConfigCpu) -> dict[str, list | Any]:
...
def request_checks(req: Request_ProxmoxVmsVMID_VmGetConfigCpu) -> dict[Any, Any]:
    """ request checks """

    extravars = {}
    extravars["proxmox_vm_action"] = "vm_get_config_cpu"
