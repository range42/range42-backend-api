...
#
# => /v0/admin/proxmox/vms/vmd_id/delete - DELETE
#
@router.delete(
    path="/delete",
...
def reply_processing(events: list[dict] | list[Any],
                     ...
                     log_plain: str,
                     rc,
                     req: Request_ProxmoxVmsVMID_Delete) -> dict[str, list | Any]:
...
def request_checks(req: Request_ProxmoxVmsVMID_Delete) -> dict[Any, Any]:
    """ request checks """
