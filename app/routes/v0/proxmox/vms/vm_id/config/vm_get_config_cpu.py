...
from app.schemas.proxmox.vm_id.config.vm_get_config_cpu import Request_ProxmoxVmsVMID_VmGetConfigCpu
from app.schemas.proxmox.vm_id.config.vm_get_config_cpu import Reply_ProxmoxVmsVMID_VmGetConfigCpu
