...
from app.schemas.proxmox.vm_id.vm_get_config_ram import Request_ProxmoxVmsVMID_VmGetConfigRam
from app.schemas.proxmox.vm_id.vm_get_config_ram import Reply_ProxmoxVmsVMID_VmGetConfigRam
