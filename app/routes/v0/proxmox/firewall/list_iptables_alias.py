...
from app.schemas.proxmox.firewall.list_iptables_alias import Request_ProxmoxFirewall_ListIptablesAlias
from app.schemas.proxmox.firewall.list_iptables_alias import Reply_ProxmoxFirewallWithStorageName_ListIptablesAlias
...
def proxmox_storage_with_storage_name_list_iso(req: Request_ProxmoxFirewall_ListIptablesAlias):
...
def reply_processing(events: list[dict] | list[Any],
                     ...
                     log_plain: str,
                     rc,
                     req: Request_ProxmoxFirewall_ListIptablesAlias) -> dict[str, list | Any]:
...
def request_checks(req: Request_ProxmoxFirewall_ListIptablesAlias) -> dict[Any, Any]:
    """ request checks """

    extravars = {}
    extravars["proxmox_vm_action"] = "firewall_vm_list_iptables_alias"
