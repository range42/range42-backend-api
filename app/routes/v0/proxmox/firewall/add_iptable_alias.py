...
from app.schemas.proxmox.firewall.add_iptable_alias import Request_ProxmoxFirewall_AddIptablesAlias
from app.schemas.proxmox.firewall.add_iptable_alias import Reply_ProxmoxFirewallWithStorageName_AddIptablesAlias
...
#
# => /v0/admin/proxmox/firewall/alias/add
#
@router.post(
    path="/vm/alias/add",
...
def reply_processing(events: list[dict] | list[Any],
                     ...
                     log_plain: str,
                     rc,
                     req: Request_ProxmoxFirewall_AddIptablesAlias) -> dict[str, list | Any]:
...
def request_checks(req: Request_ProxmoxFirewall_AddIptablesAlias) -> dict[Any, Any]:
    """ request checks """
