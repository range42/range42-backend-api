...
from app.schemas.proxmox.firewall.disable_firewall_dc import Request_ProxmoxFirewall_DisableFirewallDc
from app.schemas.proxmox.firewall.disable_firewall_dc import Reply_ProxmoxFirewallWithStorageName_DisableFirewallDc
...
def proxmox_storage_with_storage_name_list_iso(req: Request_ProxmoxFirewall_DisableFirewallDc):
...
def reply_processing(events: list[dict] | list[Any],
                     ...
                     log_plain: str,
                     rc,
                     req: Request_ProxmoxFirewall_DisableFirewallDc) -> dict[str, list | Any]:
...
def request_checks(req: Request_ProxmoxFirewall_DisableFirewallDc) -> dict[Any, Any]:
    """ request checks """
