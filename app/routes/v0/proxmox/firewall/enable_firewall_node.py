...
from app.schemas.proxmox.firewall.enable_firewall_node import Request_ProxmoxFirewall_EnableFirewallNode
from app.schemas.proxmox.firewall.enable_firewall_node import Reply_ProxmoxFirewallWithStorageName_EnableFirewallNode
...
def proxmox_storage_with_storage_name_list_iso(req: Request_ProxmoxFirewall_EnableFirewallNode):
...
def reply_processing(events: list[dict] | list[Any],
                     ...
                     log_plain: str,
                     rc,
                     req: Request_ProxmoxFirewall_EnableFirewallNode) -> dict[str, list | Any]:
...
def request_checks(req: Request_ProxmoxFirewall_EnableFirewallNode) -> dict[Any, Any]:
    """ request checks """

    extravars = {}
    extravars["proxmox_vm_action"] = "firewall_node_enable"
