...
from app.schemas.proxmox.firewall.enable_firewall_vm import Request_ProxmoxFirewall_EnableFirewallVm
from app.schemas.proxmox.firewall.enable_firewall_vm import Reply_ProxmoxFirewallWithStorageName_EnableFirewallVm
...
def proxmox_storage_with_storage_name_list_iso(req: Request_ProxmoxFirewall_EnableFirewallVm):
...
def reply_processing(events: list[dict] | list[Any],
                     ...
                     log_plain: str,
                     rc,
                     req: Request_ProxmoxFirewall_EnableFirewallVm) -> dict[str, list | Any]:
...
def request_checks(req: Request_ProxmoxFirewall_EnableFirewallVm) -> dict[Any, Any]:
    """ request checks """

    extravars = {}
    extravars["proxmox_vm_action"] = "firewall_vm_enable"
