...
#
# => /v0/admin/proxmox/firewall/node/disable
#
@router.post(
    path="/node/disable",
...
def reply_processing(events: list[dict] | list[Any],
                     ...
                     log_plain: str,
                     rc,
                     req: Request_ProxmoxFirewall_DistableFirewallNode) -> dict[str, list | Any]:
...
def request_checks(req: Request_ProxmoxFirewall_DistableFirewallNode) -> dict[Any, Any]:
    """ request checks """
