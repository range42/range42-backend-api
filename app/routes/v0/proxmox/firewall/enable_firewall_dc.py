...
from app.schemas.proxmox.firewall.enable_firewall_dc import Request_ProxmoxFirewall_EnableFirewallDc
from app.schemas.proxmox.firewall.enable_firewall_dc import Reply_ProxmoxFirewallWithStorageName_EnableFirewallDc
...
#
# => /v0/admin/proxmox/firewall/datacenter/enable
#
@router.post(
...
def reply_processing(events: list[dict] | list[Any],
                     ...
                     log_plain: str,
                     rc,
                     req: Request_ProxmoxFirewall_EnableFirewallDc) -> dict[str, list | Any]:
...
def request_checks(req: Request_ProxmoxFirewall_EnableFirewallDc) -> dict[Any, Any]:
    """ request checks """
