...
from app.schemas.proxmox.network.node_name.delete_network import Request_ProxmoxNetwork_WithNodeName_DeleteInterface
from app.schemas.proxmox.network.node_name.delete_network import Reply_ProxmoxNetwork_WithNodeName_DeleteInterface
...
#
# => /api/v0/admin/proxmox/network/node/delete
#
@router.post(
    path="/node/delete",
...
def reply_processing(events: list[dict] | list[Any],
                     ...
                     log_plain: str,
                     rc,
                     req: Request_ProxmoxNetwork_WithNodeName_DeleteInterface) -> dict[str, list | Any]:
...
def request_checks(req: Request_ProxmoxNetwork_WithNodeName_DeleteInterface) -> dict[Any, Any]:
    """ request checks """

    extravars = {}
    extravars["proxmox_vm_action"] = "network_delete_interfaces_node"
