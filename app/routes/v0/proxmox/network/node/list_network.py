...
from app.schemas.proxmox.network.node_name.list_network import Request_ProxmoxNetwork_WithNodeName_ListInterface
from app.schemas.proxmox.network.node_name.list_network import Reply_ProxmoxNetwork_WithNodeName_ListInterface
...
#
# => /api/v0/proxmox/network/node/list
#
@router.post(
    path="//node/list",
...
def reply_processing(events: list[dict] | list[Any],
                     ...
                     log_plain: str,
                     rc,
                     req: Request_ProxmoxNetwork_WithNodeName_ListInterface) -> dict[str, list | Any]:
...
def request_checks(req: Request_ProxmoxNetwork_WithNodeName_ListInterface) -> dict[Any, Any]:
    """ request checks """

    extravars = {}
    extravars["proxmox_vm_action"] = "network_list_interfaces_node"
