...
from app.schemas.proxmox.network.vm_id.delete_network import Request_ProxmoxNetwork_WithVmId_DeleteNetwork
from app.schemas.proxmox.network.vm_id.delete_network import Reply_ProxmoxNetwork_WithVmId_DeleteNetworkInterface
...
def reply_processing(events: list[dict] | list[Any],
                     ...
                     log_plain: str,
                     rc,
                     req: Request_ProxmoxNetwork_WithVmId_DeleteNetwork) -> dict[str, list | Any]:
...
def request_checks(req: Request_ProxmoxNetwork_WithVmId_DeleteNetwork) -> dict[Any, Any]:
    """ request checks """
