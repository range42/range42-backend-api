...
from app.schemas.bundles.core.proxmox.configure.default.vms.create_vms_student_default  import Request_BundlesCoreProxmoxConfigureDefaultVms_CreateStudentVms
...
#
# => /v0/admin/run/bundles/core/proxmox/configure/vms/create-vms-student
#
@router.post(
...
def bundles_proxmox_configure_default_vms_create_vms_student(
        req: Request_BundlesCoreProxmoxConfigureDefaultVms_CreateStudentVms):
    action_name = "core/proxmox/configure/default/vms/create-vms-student"
...
def request_checks(req: Request_BundlesCoreProxmoxConfigureDefaultVms_CreateStudentVms) -> dict[Any, Any]:
    """ request checks """
