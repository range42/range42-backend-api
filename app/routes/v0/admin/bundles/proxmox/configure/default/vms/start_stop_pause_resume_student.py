...
#
@router.post(
    path="core/proxmox/configure/default/start-vms-student",
...
def bundles_proxmox_configure_default_vms_stop_vms_vuln(req: Request_BundlesCoreProxmoxConfigureDefaultVms_StartStopPauseResumeAdminVulnStudentVms):
    ...
    return bundles_proxmox_configure_default_vms_run(req,
                                                     "core/proxmox/configure/default/vms/start-stop-pause-resume-vms-student",
                                                     "vm_start"
                                                     )
...
#
# => /v0/admin/run/bundles/core/proxmox/configure/default/stop-vms-student
#
@router.post(
    path="core/proxmox/configure/default/stop-vms-student",
...
def bundles_proxmox_configure_default_vms_stop_vms_vuln(req: Request_BundlesCoreProxmoxConfigureDefaultVms_StartStopPauseResumeAdminVulnStudentVms):
    ...
    return bundles_proxmox_configure_default_vms_run(req, "core/proxmox/configure/default/vms/start-stop-pause-resume-vms-student",
                                                     "vm_stop"
                                                     )
...
#
# => /v0/admin/run/bundles/core/proxmox/configure/default/pause-vms-student
#
@router.post(
    path="core/proxmox/configure/default/pause-vms-student",
...
#
# => /v0/admin/run/bundles/core/proxmox/configure/default/resume-vms-student
#
@router.post(
    path="core/proxmox/configure/default/resume-vms-student",
