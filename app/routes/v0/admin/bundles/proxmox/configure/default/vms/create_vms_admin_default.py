...
from app.schemas.bundles.core.proxmox.configure.default.vms.create_vms_admin_default import Request_BundlesCoreProxmoxConfigureDefaultVms_CreateAdminVms
from app.schemas.bundles.core.proxmox.configure.default.vms.create_vms_admin_default import Reply_BundlesCoreProxmoxConfigureDefaultVms_CreateAdminVms
...
#
# => /v0/admin/run/bundles/core/proxmox/configure/vms/create-admin
#
@router.post(
...
def bundles_proxmox_configure_default_vms_create_vms_admin(
        req: Request_BundlesCoreProxmoxConfigureDefaultVms_CreateAdminVms):
    action_name = "core/proxmox/configure/default/vms/create-vms-admin"
...
def request_checks(req: Request_BundlesCoreProxmoxConfigureDefaultVms_CreateAdminVms) -> dict[Any, Any]:
    """ request checks """
    ...
    for required in allowed_vms:
        if required not in req.vms:
            raise HTTPException(status_code=400, detail=f"Missing required vm key {required}")
