...
from app.schemas.bundles.core.linux.ubuntu.install.docker_compose import Request_BundlesCoreLinuxUbuntuInstall_DockerCompose
from app.schemas.bundles.core.linux.ubuntu.install.docker_compose import Reply_BundlesCoreLinuxUbuntuInstall_DockerCompose
...
#
# => /v0/admin/run/actions/core/linux/ubuntu/install/docker-compose
#
@router.post(
...
def bundles_core_linux_ubuntu_install_docker_compose_router(req: Request_BundlesCoreLinuxUbuntuInstall_DockerCompose):

    action_name = "core/linux/ubuntu/install/docker"
    #
...
def request_checks(req: Request_BundlesCoreLinuxUbuntuInstall_DockerCompose) -> dict[Any, Any]:
    """ request checks """
