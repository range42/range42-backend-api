...
from app.schemas.bundles.core.linux.ubuntu.install.docker import Request_BundlesCoreLinuxUbuntuInstall_Docker
from app.schemas.bundles.core.linux.ubuntu.install.docker import Reply_BundlesCoreLinuxUbuntuInstall_Docker
...
#
# => /v0/admin/run/actions/core/linux/ubuntu/install/docker
#
@router.post(
...
def bundles_core_linux_ubuntu_install_docker_router(req: Request_BundlesCoreLinuxUbuntuInstall_Docker):
...
def request_checks(req: Request_BundlesCoreLinuxUbuntuInstall_Docker) -> dict[Any, Any]:
    """ request checks """
